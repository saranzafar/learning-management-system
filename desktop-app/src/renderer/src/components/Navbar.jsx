        ...
        <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 px-4 py-4">
                <Link to="/home/teacher"
                    className="flex items-center px-4 py-2 my-2 text-black hover:bg-black hover:text-white gap-2 font-semibold rounded-md">
            ...
            <nav className="px-4 py-4">
                <button
                    ...
                    className="flex items-center px-4 py-2 my-2 text-black hover:text-red-600 gap-2 font-semibold rounded-md w-full text-left"
                >
